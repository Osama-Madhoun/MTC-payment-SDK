...
<div class="container">
    ...
    <h1>Stripe Payment Gateway  <br/>MTC Payment sdk</h1>
        ...
        <div class="col-md-6 col-md-offset-3">
            <div class="panel panel-default credit-card-box">
                ...
                <div class="panel-body">
                    ...
                    <form
                            role="form"
                            action="{{ route($model->verify_route_name, ["payment" => "stripe"]) }}"
                            method="post"
                            class="require-validation"
                            data-cc-on-file="false"
                            data-stripe-publishable-key="{{ $data['stripe_key'] }}"
                            id="payment-form">
                        @csrf
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                ...
                                <button class="btn btn-primary btn-lg btn-block" type="submit">Pay Now ({{$data['currency']}} {{$data['amount']}})</button>
                            </div>
                        </div>
