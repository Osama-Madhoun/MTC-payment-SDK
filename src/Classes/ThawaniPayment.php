...
class ThawaniPayment extends BaseController implements PaymentInterface
{
    ...
    {
        $this->thawani_url = config('MTC-payments.THAWANI_URL');
        $this->thawani_api_key = config('MTC-payments.THAWANI_API_KEY');
        $this->thawani_publishable_key = config('MTC-payments.THAWANI_PUBLISHABLE_KEY');
